    ...
    return (
        <section id="proyectos" className='proyectos'>
            ...
            <div className="flex-container-proyectos">
                ...
                <Proyecto img={imgLocademia} alt="Imagen proyecto Locademia" title="Locademia" descripcion="Clon de la tienda oficial de Racing Club de Avellaneda, desarrollado como un
                ...
                {/* <Proyecto img={imgApiClima} alt="Imagen proyecto Weather - API" title="OpenWeatherMap - API" descripcion="Aplicación que permite consultar el clima actual de cualquier
                ...
                <Proyecto img={imgTechShop} alt="Imagen proyecto TechShop" title="TechShop" descripcion="TechShop es un e-commerce de tecnología desarrollado en React, completamente responsive. Permite a los usuarios explorar y buscar productos fácilmente, consultar el detalle de cada item con control de stock en tiempo real, y gestionar su carrito de compras de forma intuitiva." skill1="REACT" page="https://tech-shop-daddese.netlify.app/" repo="https://github.com/facudaddese/tech-shop" />
            </div>
        </section>
    )
}
